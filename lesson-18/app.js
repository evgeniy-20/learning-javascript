...
// let newAarr = arr.length;
// for(let i = newAarr; i >= 0; i--) {
//     console.log(arr[i]);
// }
...
// 'Май', 'Июнь', 'Июль', 'Aвгуст', 'Сентябрь', 'Октябрь', 
// 'Ноябрь', 'Декабрь']
// for (let elem of arr) {
//     console.log(elem);
// }
...
// console.log(obj);
// Дана строка:
// let string = 'некоторая тестовая строка';
// // Сделать первую и последнюю строку в Сделать регистре. При помощи конкатенации и через шаблонные строки.
// let newString = `${}`
// Найти положение слова 'строка' в строке.
// Найти положение второго пробела в строке («вручную» ничего не считать).
// Получить строку с 5-го по 9-й символу.
// Получить число pi из Math и округлить его до 2-х знаков после точки.
// Используя математику, найти максимальное и минимальное число из представленного ряда 15, 11, 16, 12, 51, 12, 13, 51.
...
// Проверить результат вычислений 0.6 + 0.7 - как привести к нормальному виду (1.3)?
// Создать объект с полем товар , равным 'iPhone'.
// Добавить в объект поле цена , равное 1000 и поле валюта , равное 'доллар'.
// Добавить поле подробностей , которое будет содержать объект с полями модель и цвет
// //  Задание с "плюсом":  написать функцию, которая будет делить набор на массив используя функции: calculateChars, findMaxValue
...
//     }
// }
// console.log('двоек : ', count_two)
// console.log('троек :  ', count_three)
// let arr = [1, 2, 3, 4, 5];
...
// let arr = Math.pow(2,10);
// console.log(arr);
//Найдите квадратный корень из 245.
// let arr = Math.sqrt(245);
// console.log(arr);
//Найдите квадратный корень из 379. Результат округлите до целых, до десятых, до сотых.
// let arr = Math.sqrt(379);
// let newArr = Math.round(arr);
// console.log(newArr);
// let arr = Math.sqrt(379);
// let newArr = Math.ceil(arr);
// console.log(newArr);
// let arr = Math.sqrt(379);
// let newArr = Math.floor(arr);
// console.log(newArr);
...
// // let newStr = str.substr(2,14);
// // let newStr = str.substring(2,16);
// let newStr = str.slice(2,16);
// console.log(newStr);
//Дана строка 'abcde'. Определите позицию буквы 'c' в этой строке.
//Дана строка. Проверьте, есть ли в этой строке символ 'a'.
// let str = 'abcde';
// // let newStr = str.indexOf('c');
// let newStr = str.lastIndexOf('a');
// console.log(newStr);
...
// 	return sum1 == sum2;
// }
// console.log(checkDigitsPairsSum(result));
